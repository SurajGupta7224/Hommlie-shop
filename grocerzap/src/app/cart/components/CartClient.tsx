    ...
    <div className="min-h-screen bg-background pb-32 md:pb-8">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex items-center gap-3">
          <Link href="/product-listing" className="flex items-center justify-center w-9 h-9 rounded-full bg-muted hover:bg-border transition-colors flex-shrink-0">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/cart" className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold text-primary bg-secondary transition-colors">
